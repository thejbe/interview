...
export default async function BookingsPage() {
    ...
    if (error) {
        ...
        return <div className="p-8 text-red-500">Error loading bookings.</div>;
    }
    ...
    return (
        <div className="pb-24">
            <div className="flex items-center justify-between mb-8">
                ...
                <Link href="/recruiter/bookings/new" className="flex items-center justify-center px-4 py-2 bg-primary text-[#142210] font-bold rounded-full hover:bg-primary/90 transition-colors">
