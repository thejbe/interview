...
export function TemplateForm({ initialData, companies, managers, departments, mode, onSuccess, isModal }: TemplateFormProps) {
    ...
    return (
        <div className={`relative ${isModal ? 'max-w-4xl mx-auto' : 'flex flex-col h-full'}`}>
            {/* Email Modal */}
            {showEmailModal && (
                    ...
                    <Header
                        title={
                            <div className="flex items-center gap-4">
                                <Link href="/recruiter/templates" className="flex items-center justify-center w-8 h-8 rounded-full bg-[#152211] border border-[#2c4823] text-white/60 hover:text-white hover:bg-[#2c4823] transition-all">
                        ...
                        actions={
                            <div className="flex gap-3">
                                {initialData?.id && (
                                    <>
                                        <button
                                            ...
                                            className="flex items-center justify-center w-8 h-8 rounded-lg border border-[#2c4823] bg-[#152211] text-[#9fc992] hover:text-white hover:border-primary/50 transition-all font-medium"
                                        ...
                                        <Button
                                            ...
                                            className="h-8 px-3 text-xs bg-[#0078d4] text-white hover:bg-[#0078d4]/90 border-transparent shadow-sm"
                                        >
                                ...
                                <Button onClick={handleSubmit} disabled={loading} className="h-8 px-3 text-xs">
            ...
            <div className={`${isModal ? '' : 'max-w-4xl mx-auto p-8 w-full'}`}>
                <form
                    id="template-form"
